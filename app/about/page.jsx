...
export default function About() {
  return (
    <main className="flex flex-col justify-between h-full bg-brand-100 lg:p-36 md:p-24 p-14 overflow-y-scroll no-scrollbar">
      <div className="flex h-full md:flex-row flex-col items-center my-16 ">
        <div className="lg:w-1/2 md:pr-28 mb-10">
          <h1 className="lg:text-7xl md:text-5xl text-3xl font-bold text-blue-900">
            About US!
          </h1>
        </div>
        <div className="flex flex-col items-center justify-start md:w-1/2 w-full md:px-12 px-0">
      ...
      <div className="flex h-full my-16 md:flex-row flex-col items-center">
        ...
        <div className="flex flex-col items-center justify-center md:w-1/2 h-full bg-blue-900 p-12">
